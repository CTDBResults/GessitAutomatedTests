...
Feature: Some feature
  ...
  Scenario Outline: GES-70, GES-72
    ...
    Examples: 
      ...
      | Gessit     | test1@test.com | Password123  | Invalid login details. Please try again. |
      | Gessit     |                | Password123  | Invalid login details. Please try again. |
  ...
  Scenario Outline: GES-72
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  |
  ...
  Scenario Outline: GES-3 Scenario 4 Create patient tests (from,LHS menu), Postal address different from residential address
    ...
    And I enter the details as
      ...
      | FirstNameInput | <FirstName>    |
    And I use "DOB" to enter "12/12/2001"
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | Testprodtwott | abwc@abc.com | Patientprodtt |   0422000000 |        7 | The Alfred |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |
  ...
  Scenario Outline: GES-3 Create patient tests (from,RHS), Postal address different from residential address
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | Hemantautoprodott | abwc@abc.com | testTwowwprodtt | The Alfred |   0422000000 |        7 |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |
  ...
  Scenario Outline: GES-9 As a GP/Specialist, I want the ability to record the patient's medications so that the appropriate treatment plan can be selected
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | Hemantautoprodott | abwc@abc.com | Smithprodtt |   0422000000 |        7 |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |
  ...
  Scenario Outline: GES-34 As a GP/Specialist, I want the ability to record a diagnosis against a patient's record so that the relevant assessment can be performed
    ...
    #   And I select "Brown, Jack" from "Specialist"
    And I select "Payne, Richard" from "gp"
    And I click on "Save"
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | TestThirtyFourprodtt | The Alfred | abwc@abc.com | testprodtt |   0422000000 |        7 |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |
  ...
  Scenario Outline: GES-8 patient search, GES-351 As a GP/Specialist, I want to create an Assessment form for a diagnosis and enter a patients clinical details and intercurrent conditions
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | TestThirtyFourprodtt |
  ...
  Scenario Outline: GES-142 As a GP/Specialist, I want to create an Assessment form for a diagnosis and enter the HCV details so that I know what treatment options are applicable
    ...
    Examples: 
      | PortalName | email                       | Password | FirstName  | CU    | EmailInput   | LastName    | contactInput | medicare | postCode | ResidentialAddress1 | Weight | Height | ResidentialAddress2 | Suburb   |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | Bobbyprott | The Alfred | abwc@abc.com | Smithprodtt |   0422000000 |        7 |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |
  ...
  Scenario Outline: GES-164 , Also covers E2E scenarios login as gp
    ...
    Examples: 
      ...
      | Gessit     | drrichard.gp@gmail.com | Password123  | TestOnesixfourprodtt | abwc@abc.com | NOTCirrhoticprodtt | Burwood |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic |
  ...
  Scenario Outline: GES-164 , Also covers E2E scenarios
    ...
    Examples: 
      | PortalName | email                       | Password | FirstName                           | EmailInput   | LastName                 | CU    | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message       |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | TestOnesixfourprodtt                | abwc@abc.com | NOTCirrhoticprodtt       | The Alfred |   0422000000 |        7 |     2222 |       40 |  50 |      200 |               |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | TestOnesixfourSpecilToApproveprodtt | abwc@abc.com | PatientIsCirrhoticprodtt | The Alfred |    042211111 |        7 |     2222 |       40 |  50 |       20 | Complications |
  ...
  Scenario Outline: Search for the person created above
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | TestOnesixfourSpecilToApproveprodtt | abwc@abc.com | PatientIsCirrhoticprodtt |    042211111 |        7 |     2222 |       40 |  50 |       20 | Complications |
  ...
  Scenario Outline: Check Cirrosi Logic
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | CheckCirrhosisLogicprodtt | abwc@abc.com | NOTCirrhoticprodtt | The Alfred |   0422000000 |        7 |     2222 |       40 |  50 |      200 |          | Chandigarh |                  84 |    175 | Bhilowal |                     |
  ...
  Scenario Outline: GES-249, As a GP, I want the ability to start a treatment plan without needing to send it to a Specialist for approval and completed added as well.
    ...
    Examples: 
      ...
      | Gessit     | drrichard.gp@gmail.com | Password123  | GPApprovedPlanprodtt | Burwood | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic |
  ...
  Scenario Outline: GES-521, As a GP/Specialist, I want to be able to view a task on a draft treatment plan in both a simplified and detailed view
    ...
    Examples: 
      ...
      | Gessit     | drrichard.gp@gmail.com | Password123  | TestFiveTwentyOnetaketwoprodtt | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 | Burwood |       40 |  50 |      200 | Non-Cirrhotic | Chandigarh | Chandigarh          |     78 |    175 | bheelowal           |
@Gessit_Regression
  Scenario Outline: GES-521, As a GP/Specialist, I want to be able to view a task on a draft treatment plan in both a simplified and detailed view
    Given I want to login to portal "<PortalName>"
    ...
    Examples: 
      ...
      | Gessit     | drrichard.gp@gmail.com | Password123  | TestFiveTwentyOnetaketwoprodtt | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic |
@Gessit_Regression
  Scenario Outline: GES-521, As a GP/Specialist, I want to be able to view a task on a draft treatment plan in both a simplified and detailed view
    Given I want to login to portal "<PortalName>"
    And I wait for "8000" millisecond
    ...
    Examples: 
      | PortalName | email               | Password | FirstName            | EmailInput   | LastName  | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message1      |
      | Gessit     | drrichard.gp@gmail.com | Password123  | GPApprovedPlanprodtt | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic |
@Gessit_Regression
  Scenario Outline: GES-499, As a Specialist, I want the ability to approve a draft treatment plan that I have created
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | TestFourNineNineprodtt | The Alfred | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic | Chandigarh | Chandigarh          |     78 |    175 | bheelowal           |
  ...
  Scenario Outline: Set 1..... login as gp.......create a draft (NC)....... approve
    ...
    Examples: 
      | PortalName | email               | Password | FirstName        | EmailInput   | LastName  | CU  | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message |
      | Gessit     | drrichard.gp@gmail.com | Password123  | EtoESetTwoprodtt | abwc@abc.com | GAPprodtt | Burwood |   0422000000 |        7 |     2222 |       40 |  50 |      200 |         |
  ...
  Scenario Outline: Set 1..... login as gp.......create a draft (C)....... SHOULD NOT BE ABLE TO APPROVE (different popup options)....send it to specialist
    ...
    Examples: 
      | PortalName | email               | Password | FirstName                 | EmailInput   | LastName  | CU  | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message       |
      | Gessit     | drrichard.gp@gmail.com | Password123  | CheckStatusForCPravprodtt | abwc@abc.com | GAPprodtt | Burwood |   0422000000 |        7 |     2222 |       40 |  50 |       20 | Complications |
  ...
  Scenario Outline: Set 2..... login as gp.......Create NC....... approve
    ...
    Examples: 
      ...
      | Gessit     | drrichard.gp@gmail.com | Password123  | SetTwoprodtt | abwc@abc.com | GAPprodtt |   0422000000 | Burwood |        7 |     2222 |       40 |  50 |      200 |         |
  ...
  Scenario Outline: Set 4..... login as specialist.......create a draft (NC)....... approve
    ...
    Examples: 
      | PortalName | email                       | Password | FirstName    | EmailInput   | LastName  | contactInput | CU    | medicare | postCode | aprilevl | ast | Platelet | Message |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | SetTwoprodtt | abwc@abc.com | GAPprodtt |   0422000000 | The Alfred |        7 |     2222 |       40 |  50 |      200 |         |
  ...
  Scenario Outline: Set 7..... login as specialist.......create a draft (C).......save and  approve
    ...
    Examples: 
      | PortalName | email                       | Password | FirstName    | EmailInput   | LastName  | contactInput | CU    | medicare | postCode | aprilevl | ast | Platelet | Message       |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | SetTwoprodtt | abwc@abc.com | GAPprodtt |   0422000000 | The Alfred |        7 |     2222 |       40 |  50 |       20 | Complications |
  ...
  Scenario Outline: GES-119, GES-621 As an Administrator, I want the ability to create and view Care Units
    ...
    Examples: 
      ...
      | Gessit     | jamesharidy@gmail.com			 | Password123  | Test119and621     |     3000 | 13 Kona St     |       99880099 | test@test.com | Melbourne |
  ...
  Scenario Outline: GES-233 - As a GP/Specialist, I should be able to add notes to a treatment plan page
    ...
    Examples: 
      ...
      | Gessit     | drrichard.gp@gmail.com | Password123  | testTwoThreeThreeprodtt | abwc@abc.com | GPNCprodtt |   0422000000 | Burwood |        7 |     2222 |       40 |  50 |      200 |         | Based on the information | I am a GP | entering note | GP, the first contact | Check if i can add to approved |           |     |         |            |                   |         |             |             |
  ...
  Scenario Outline: GES-233 - As a GP, I should be able to add notes to a Cirrotic treatment plan page
    ...
    Examples: 
      ...
      | Gessit     | drrichard.gp@gmail.com | Password123  | testTwoThreeThreeprodtt | abwc@abc.com | GPCprodtt |   0422000000 |        7 | Burwood |     2222 |       40 |  50 |       20 |         |      | I am a GP | entering note | GP       | Check if i can add to approved |
  ...
  Scenario Outline: GES-233 - As a GP, I should be able to add notes to a Cirrotic treatment plan page
    ...
    Examples: 
      ...
      | Gessit     | drjack.specialist@gmail.com    | Password123  | testTTTloginSpecialistprodtt | abwc@abc.com | SPCprodtt | The Alfred |   0422000000 |        7 |     2222 |       40 |  50 |       20 |         |      | I am a GP | entering note | SPecialist | Check if specialist can add to approved |
  ...
  Scenario Outline: GES-810, GES-233 - As a GP, I should be able to add notes to a Cirrotic treatment plan page
    ...
    Examples: 
      | PortalName | email                       | Password | FirstName                    | EmailInput   | LastName  | contactInput | medicare | CU    | postCode | aprilevl | ast | Platelet | Message | text | addnote   | noteinput     | addnote2   | noteinput2                              |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | testTTTloginSpecialistprodtt | abwc@abc.com | SPCprodtt |   0422000000 |        7 | The Alfred |     2222 |       40 |  50 |       20 |         |      | I am a GP | entering note | SPecialist | Check if specialist can add to approved |
  ...
  Scenario Outline: GES-172 As Specialist, I want the ability to add treatment tasks to an approved treatment plan
    ...
    Examples: 
      | PortalName | email                       | Password | FirstName            | EmailInput   | LastName                 | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message       |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | TestOnesixfourprodtt | abwc@abc.com | PatientIsCirrhoticprodtt |    042211111 |        7 |     2222 |       40 |  50 |       20 | Complications |
  ...
  Scenario Outline: GES-820 As a System Admin I want to view the menu items so that I know what functions I have access to based on my role
    ...
    Examples: 
      | PortalName | email                         | Password | FirstName   | CU    | EmailInput   | LastName    | contactInput | medicare | postCode | ResidentialAddress1 | Weight | Height | ResidentialAddress2 | Suburb   |
      | Gessit     | jamesharidy@gmail.com			 | Password123  | Bobbyprodtt | The Alfred | abwc@abc.com | Smithprodtt |   0422000000 |        7 |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |
  ...
  Scenario Outline: GES-810 As a GP/Specialist I want to view the menu items so that I know what functions I have access to based on my role
    ...
    Examples: 
      | PortalName | email                       | Password | FirstName   | CU    | EmailInput   | LastName    | contactInput | medicare | postCode | ResidentialAddress1 | Weight | Height | ResidentialAddress2 | Suburb   |
      | Gessit     | drrichard.gp@gmail.com         | Password123  | Bobbyprodtt | The Alfred | abwc@abc.com | Smithprodtt |   0422000000 |        7 |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | Bobbyprodtt | The Alfred | abwc@abc.com | Smithprodtt |   0422000000 |        7 |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |
  ...
  Scenario Outline: GES-119, GES-621 As an Administrator, I want the ability to create and view Care Units
    ...
    Examples: 
      | PortalName | email                         | Password | CareUnitNameValue  | Postcode | Address Line 1 | Contact Number | Contact Email | Suburb    |
      | Gessit     | jamesharidy@gmail.com			 | Password123  | Test119and621tnine |     3000 | 13 Kona St     |       99880099 | test@test.com | Melbourne |
  ...
  Scenario Outline: GES-192 preceded by below  test case and create a care unit which will be attached to above practitioner
    ...
    Examples: 
      ...
      | Gessit     | jamesharidy@gmail.com			 | Password123  | bhonsdu |     3000 | 13 Kona St     |       99880099 | test@test.com | Melbourne |
  ...
  Scenario Outline: As an Administrator, I want the ability to create a Practitioner GES-192
    ...
    Examples: 
      ...
      | Gessit     | jamesharidy@gmail.com			 | Password123  | Bobbyprodtt | chooktafatta | practionerdasecondname |   12345674 |      00001111 | h@1d0n0texixt.com | Anypassword123 | Anypassword123 |
  ...
  Scenario Outline: Login as Nurse and assign the patient to gp/specialist
    ...
    Examples: 
      ...
      | Gessit     | nurserose.gp@gmail.com| Password123  | TestNurseCreation | abwc@abc.com | SomePatient |   0422000000 |        7 | Burwood |     2222 | 344 Sector 9        |     44 |    123 | 3344 secto 19       | Oakleigh |       12 |  12 |      200 |
  ...
  Scenario Outline: GES-754:As a GP/Specialist/Nurse, I want to automatically view the drug interactions for the medications proposed on the treatment options so that I know if the treatment option is appropriate for the patient
    ...
    Examples: 
      ...
      | Gessit     | nurserose.gp@gmail.com| Password123  | TestOnesixfourSpecilToApproveprodtt | abwc@abc.com | PatientIsCirrhoticprodtt |
  ...
  Scenario Outline: GES-819 , As a Patient I want to view the menu items so that I know what functions I have access to based on my role
    ...
    Examples: 
      | PortalName | email                    | Password |
      | Gessit     | demopatient987@gmail.com | Password123  |
...
Given I want to login to portal "<PortalName>"
    ...
    Examples: 
      | PortalName | email               | Password | FirstName                      | EmailInput   | LastName  | contactInput | medicare | postCode | CU  | aprilevl | ast | Platelet | Message1      | Suburb     | ResidentialAddress1 | Weight | Height | ResidentialAddress2 |
      | Gessit     | drrichard.gp@gmail.com | Password123  | AddAndDeleteMedication | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 | Burwood |       40 |  50 |      200 | Non-Cirrhotic | Chandigarh | Chandigarh          |     78 |    175 | bheelowal           |
  ...
  Scenario Outline: GES-997, GP/Specialist creates a TP, Nurse should be able to COMMENCE Medication
    ...
    Examples: 
      | PortalName | email               | Password | FirstName               | CU  | EmailInput   | LastName  | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message1      |
      | Gessit     | drrichard.gp@gmail.com | Password123  | NurseCommenceMedication | Burwood | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic |
  ...
  Scenario Outline: GES-997-2, GP/Specialist creates a TP, Nurse should be able to COMMENCE Medication
    ...
    Examples: 
      | PortalName | email               | Password | FirstName               | CU  | EmailInput   | LastName  | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message1      |
      | Gessit     | nurserose.gp@gmail.com| Password123  | NurseCommenceMedication | Burwood | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic |
    ...
    Examples: 
      | PortalName | email               | Password | FirstName               | CU  | EmailInput   | LastName  | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message1      |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | NurseCommenceMedication | Burwood | abwc@abc.com | GAPprodtt |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic |
 ...
 # And I click on text "Request Referral to Liver Clinic"
  And I click on text "Request Specialist participation in"
    ...
    Examples: 
      | PortalName | email               | Password | FirstName               | EmailInput   | LastName   | contactInput | CU  | medicare | postCode | aprilevl | ast | Platelet | Message | text                     | addnote   | noteinput     | addnote2              | noteinput2                     | billrubin | inr | albumin | creatinine | Poorly controlled | Minimum | variscesyes | bleedingyes |
      | Gessit     | drrichard.gp@gmail.com | Password123  | sendToSpecialist | abwc@abc.com | with parameters |   0422000000 | Burwood |        7 |     2222 |       40 |  50 |      200 |         | Based on the information | I am a GP | entering note | GP, the first contact | Check if i can add to approved |           |     |         |            |                   |         |             |             |
   ...
   And I wait for "1000" millisecond
    ...
    Examples: 
      | PortalName | email               | Password | FirstName               | EmailInput   | LastName   | contactInput | CU  | medicare | postCode | aprilevl | ast | Platelet | Message | text                     | addnote   | noteinput     | addnote2              | noteinput2                     | billrubin | inr | albumin | creatinine | Poorly controlled | Minimum | variscesyes | bleedingyes |
      | Gessit     | drjack.specialist@gmail.com    | Password123  | sendToSpecialist | abwc@abc.com | with parameters |   0422000000 | Burwood |        7 |     2222 |       40 |  50 |      200 |         | Based on the information | I am a GP | entering note | GP, the first contact | Check if i can add to approved |           |     |         |            |                   |         |             |             |
  ...
  And I scroll "down" the page
    ...
    Examples: 
      | PortalName | email               | Password | FirstName            | CU  | EmailInput   | LastName  | contactInput | medicare | postCode | aprilevl | ast | Platelet | Message1      |
      | Gessit     | drrichard.gp@gmail.com | Password123  | CreateTPSixteen | Burwood | abwc@abc.com | TPSixteen |   0422000000 |        7 |     2222 |       40 |  50 |      200 | Non-Cirrhotic |