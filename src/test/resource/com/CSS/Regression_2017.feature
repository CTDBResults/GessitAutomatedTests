Feature: To test the functionality of Appication as described in Jira Stories for Iteration 1
  ...
  Scenario Outline: User views the menu items, Test 1, DCSSP-245, DCSSP-533, DCSSP-832 Description: User views the menu items Epic: Common Components
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Accounts   | Residential: Electricity | Account No. 6061134434 | 1420 Eastchase Pky |
  ...
  Scenario Outline: Check Usage Menu Item List Test 1, DCSSP-245 Description: User views the menu items Epic: Common Components
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | USAGE      | Residential: Electricity | Usage History | Contact Us  |
  ...
  Scenario Outline: Check User Menu Item List Test 1, DCSSP-745 Description: check for feature under development
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Set Up Direct Debit |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Set Up eBilling     |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Current_Bill        |
  ...
  Scenario Outline: Test20, Test21, Test22, Test23, Test24, Test26, Check Billing history page elements.
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName      | ServiceName              | ButtonName2                    | ButtonName3   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | BILLING HISTORY | Residential: Electricity | 1420 Eastchase Pky, Fort Worth | Usage History |
  ...
  Scenario Outline: Test 25, User views the Billing History page
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | BILLING HISTORY | Residential - Electricity Billing History |
  ...
  Scenario Outline: DCSSP-422, 423, PAYMENTS
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Account 6061134434 | AccountComboBox | 1420 Eastchase Pky, Fort Worth | PremiseComboBox | CurrentBillCost | LastBillCost | BillingAccountAmount | LastBillNegativeRedBill |
  ...
  Scenario Outline: Covers tests around Usage history check, Scenario 189
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   |
  ...
  Scenario Outline: DCSSP-450,DCSSP-451,DCSSP-457, PAYMENTS, To make payment from RHS "PAY" button.
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        |    6061134434 |               | Christian Test | 4007000000027 |           11 |          20 |           112 | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        |    6061134434 |            20 |                | 4007000000027 |           11 |          20 |           112 | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        |    6061134434 |            20 | Christian Test |               |           11 |          20 |           112 | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        |    6061134434 |            20 | Christian Test | 4007000000027 |              |          20 |           112 | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        |    6061134434 |            20 | Christian Test | 4007000000027 |           11 |             |           112 | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        |    6061134434 |            20 | Christian Test | 4007000000027 |           11 |          20 |               | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        |    6061134434 |            20 | Christian Test |    4007000000 |           11 |          20 |           223 | The credit card number is invalid. |

  #    | CSS        | UserNameInput | PasswordInput | Christian     | Aussie1 | Pay        | 689608083     | 5.00          | Christian Test    | 4007000000027 | 11           | 20          | 112           | Thank you, your payment has been received. |
  Scenario Outline: DCSSP-422, 423, SUCCESSFUL PAYMENTS, To make payment from RHS "PAY" button.
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName | AccountNumber | PaymentAmount | Name on Card   | Card Number   | Expiry Month | Expiry Year | Security Code | Message                                    |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        |    6061134434 |          1.10 | Christian Test | 4007000000027 |           05 |          20 |           113 | Thank you, your payment has been received. |
  ...
  Scenario Outline: DCSSP-162, DCSSP-236 edit settings......................Ellen Please verify these
    ...
    And I click on button "EditSettings"
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | christian@dbresults.com | Your changes have been saved successfully. |
  ...
  Scenario Outline: DCSSP-433, DCSSP-550 (reset password is manual), DCSSP-162 Edit Settings>> reset pwd
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Aussie           | Aussie       |                      | New Password and Confirm Password do not match. Please try again. |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Aussie           |              | Aussie               | New Password and Confirm Password do not match. Please try again. |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   |                  | Aussie       | Aussie               | Please input your current password to change your new password.   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Aussie           | DBR          | DBR                  | New Password is invalid. Please try again.                        |

  # | CSS        | UserNameInput | PasswordInput | Christian    | Aussie | Aussie        | Aussie    | Aussie            | Your changes have been saved successfully.                                             |
  ######################################################################################################################
  ...
  Scenario Outline: DCSSP-413 Scenario 1: User accesses the registration page
    ...
    And I click on button "USSCommon_wt32_block_wtMainContent_wtTermsandConditionsCheckBox"
    And I click on button "Submit"
    ...
    Examples: 
      ...
      | CSS        |     1025577469 | Moore,Betty  | 234567804 | abc        | Your password is not strong enough. |                    123 |
      | CSS        |     1025577469 | Moore,Betty  | 234567804 | mattlara   | Your password is not very secure.   |                    123 |
      | CSS        |     1025577469 | Moore,Betty  | 234567804 | CSSPhase1  | Your password is strong.            |                    123 |
      | CSS        |     1025577469 | Moore,Betty  | 234567804 | CSSPhase@1 | Your password is very secure!       |                    123 |
  ...
  Scenario Outline: DCSSP-450; DCSSP-457; DCSSP-451: Scenario 1, Scenario 2 Test 1, To make payment from LHS
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName | AccountNumber      | PaymentAmount | Name on Card   | Card Number   | Expiry Month | Expiry Year | Security Code | Message                            |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 6061134434 |               | Christian Test | 4007000000027 |           11 |          20 |           112 | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 6061134434 |            20 | Christian Test |               |           11 |          20 |           112 | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 6061134434 |            20 | Christian Test | 4007000000027 |           11 |             |           112 | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 6061134434 |            20 | Christian Test | 4007000000027 |           11 |          20 |               | Mandatory field!                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 6061134434 |            20 | Christian Test |    4007000000 |           11 |          20 |           112 | The credit card number is invalid. |
  ...
  Scenario Outline: DCSSP-450; DCSSP-457; DCSSP-451; DCSSP-492: Scenario 1, Scenario 2 Test 1, To make payment from LHS. + DCSSP-743-- Check payment made on activity history page.
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 6061134434 |          0.11 | Christian Test | 4007000000027 |           11 |          20 |           112 |
  ...
  Scenario Outline: DCSSP-450; DCSSP-457; DCSSP-451: Scenario 1, Scenario 2 Test 1, To make payment from LHS
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName | AccountNumber      | PaymentAmount | Name on Card    | Card Number   | Expiry Month | Expiry Year | Security Code |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 1071805034 |            10 | another payment | 4007000000027 |           11 |          20 |           112 |
  ...
  Scenario Outline: DCSSP-493: Invalid Login using email (scenario 3); DCSSP-551: Password Hint during login; DCSSP-28: Account locked after no of unsuccessful login attempts
    ...
    Examples: 
      ...
      | CSS        | UserNameOrEmailInput | InvalidPasswordInput | Christian         | sss               | sdfg              | sfdg              | sgfsd     | Invalid Username, Email or Password. Please try again. | Reset   | Invalid Username, Email or Password. Password Hint: life is life. |
  ...
  Scenario Outline: DCSSP-493 :As a user I want to login to the CSS using my email address so that I can access my information
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | automationtest3_for_Jane@gmail.com | blah_blah@gmail.com | Invalid Username, Email or Password. Please try again. |
  ...
  Scenario Outline: DCSSP-414: As a user I want to enter my user details so that I can complete the registration process
    ...
    Examples: 
      ...
      | CSS        |      8970235184 | Pan, Peter | 888-99-8761 | ellen.truefeldt@Dbresults.com.au | PeterPan1        | Aussie           | Aussie            | life is life | LanguagePreference | English (GB)   | ellentruefeldt | Aussie1          | Aussie1           | ellen.truefeldt2@gmail.com | bob              | Aussie1          | Aussie1           | TestUser4        | dbr              | dbr               | Aussie1          | hi                |
  ...
  Scenario Outline: DCSSP-450; DCSSP-457; DCSSP-451; DCSSP-492: Scenario 1, Scenario 2 Test 1, To make payment from LHS; DCSSP-459: scenario 1, 2, 3
    ...
    And I click on button "ActivityHistoryButton"
    And I check I am on "Activity History" page

    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName | AccountNumber      | PaymentAmount | Name on Card | Card Number   | Expiry Month | Expiry Year | Security Code |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 6061134434 |             1 | happy Test   | 4007000000027 |           11 |          20 |           112 |
  ...
  Scenario Outline: DCSSP-450; DCSSP-457; DCSSP-451: Scenario 1, Scenario 2 Test 1, To make payment from LHS; DCSSP-459: scenario 4
    ...
    And "<Item>" is displayed as "<ItemName>"
      | Item  | ItemName        |
      | Item1 | Receipt Sent To |
    And I click on button "MakeAnotherPaymentButton"
    And I check I am on "MakePayment" page
  ...
  Scenario Outline: DCSSP-489 As a user I want my name displayed in the portal so that I know I'm currently logged in
    ...
    And I wait for "30000" millisecond
    And I check I am on "Setting" page

    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | Welcome Message |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Welcome,        |
  ...
  Scenario Outline: DCSSP-449: all (Edit phone and mailing address); DCSSP-553: covers update of info (excludes ccb check)
    ...
    And I click on button "Submit"
    #   Then I see "Mobile format invalid. Expected format: (999)999-9999" displayed ....I don't know why
    And I enter the details as
      | Fields      | Value               |
      | MobilePhone | <Mobile Number2>    |
      | HomePhone   | <HomePhone Number2> |
    And I click on button "Submit"
    # Then I see "Home Phone format invalid. Expected format: (999) 999-9999" displayed ....I don't know why
    And I enter the details as
      | Fields    | Value               |
      | HomePhone | <HomePhone Number1> |
      | WorkPhone | <WorkPhone Number2> |
    And I click on button "Submit"
    #Then I see "Work Phone format invalid. Expected format: (999) 999-9999" displayed ....I don't know why
    And I enter the details as
      | Fields           | Value               |
      | Email            | <Email>             |
      | WorkPhone        | <WorkPhone Number1> |
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | (999) 11-g     | (999) 989-1122    | (888) 777-6654    | (903) 888-7161 | (99) 77-60        | (88) 71           | Apt. 26, 30 Saint Francis Pl |               | San Francisco | CA    |     94107 | United States of America | CountriesComboBox | email@Aussie.com.au |
  ...
  Scenario Outline: DCSSP-520: Already registered or already activated
    ...
    Then I click on button "wtSubmitButton3"
    And I check I am on "Login" page

    Examples: 
      | PortalName | Account Number1 | BillName1        | SSN1        | Account Number2 | BillName2   | SSN2        |
      | CSS        |      6061134434 | Jakob, Christian | 234-56-7822 |      4415168071 | Test, Simon | 211-02-0091 |
  ...
  Scenario Outline: DCSSP-520: Already registered or already activated and user tries again.
    ...
    Examples: 
      ...
      # | CSS        |      9353248310 | Da Vinci, Leonardo | 777-78-7807 |      4415168071 | Test, Simon | 998-11-1515 | timepass@gmail.com | Simon            | Aussie       | Aussie        | life is life | LanguagePreference | English (GB)   |
      | CSS        |      6061134434 | Jakob, Christian | 234-56-7822 |      9474110792 | Shaw,Stuart | 1234-99-321 | timepass@gmail.com | Simon            | Aussie           | Aussie            | life is life | LanguagePreference | English (GB)   |
  ...
  Scenario Outline: Continue with 520, Scenario 2: User registers and their account is not activated
    ...
    Examples: 
      ...
      | CSS        |     6061134434 | Jakob, Christian | 234-56-7822 |
@CSS_Regression
  Scenario Outline: DCSSP-493 :As a user I want to login to the CSS using my email address so that I can access my information. This will keep runing the validations till CAPTCHA
    ...
    Examples: 
      ...
      | CSS        | CSS2        | UserNameInput | PasswordInput | Christian | Aussie   | test3@dbresults.com.au | blah_blah@gmail.com | Invalid Username, Email or Password. Please try again. |
  ...
  Scenario Outline: DCSSP-758: This is for defect 758, email address should not be duplicated with edit settings option. This should not accept the duplicate email address.
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | hemant.shori@dbresults.com.au |
  ...
  Scenario Outline: DCSSP-450; DCSSP-457; DCSSP-451; DCSSP-492: Scenario 1, Scenario 2 Test 1, To make payment from LHS. + DCSSP-743-- Check payment made on activity history page.
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName | AccountNumber      | PaymentAmount | Name on Card   | Card Number   | Expiry Month | Expiry Year | Security Code |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Pay        | Account 1071805034 |          0.11 | Christian Test | 4007000000027 |           11 |          20 |           112 |
  ...
  Scenario Outline: User changes password with password strength. DCSSP-790 Description: Change password rule
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | abc         |                |                  | Your password is not strong enough.        |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   |      123456 |                |                  | Your password is not strong enough.        |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | mattlara    |                |                  | Your password is not very secure.          |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | CSSPhase1   |                |                  | Your password is strong.                   |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | CSSPhase@1  |                |                  | Your password is very secure!              |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Aussie      | Aussie         | ApplesandOranges | Your changes have been saved successfully. |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | Aussie      | Aussie         | ApplesandOranges | Your changes have been saved successfully. |
  ...
  Scenario Outline: DCSSP-67 : As a user I want to view my account’s financial history so that I can review the account's transactions over a period of time
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | hemant.shori@dbresults.com.au | Account 0370837468 | AccountComboBox | Account 2754232312 | Account No. 2754232312 |
  ...
  Scenario Outline: DCSSP-730: update Profile Address Scenario 1
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | test4@test.com |                        |                                            |
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | test4@test.com | DBResult123s@gmail.com | Your changes have been saved successfully. |
  ...
  Scenario Outline: DCSSP-730: update Profile Address Scenario 2
    ...
    Examples: 
      ...
      | CSS        | UserNameInput | PasswordInput | Christian | Aussie   | test4@test.com | TestLine | Your changes have been saved successfully. | DBResults   |
  ...
  Scenario Outline: Testing User Roles DCSSP-929 Description: User should be able to access CSSPortal Epic: Portal Admin
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName | Password |
      | CSS        | UserNameInput | PasswordInput | Bob      | Aussie   |
      | CSS        | UserNameInput | PasswordInput | Leonardo | Aussie   |
  ...
  Scenario Outline: Testing User Roles DCSSP-930 Description: User should be able to access UAP Epic: Portal Admin
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password |
      | UAP        | UserNameInput | PasswordInput | Lisa      | Aussie   |
      | UAP        | UserNameInput | PasswordInput | Christian | Aussie   |
  ...
  Scenario Outline: Testing User Roles DCSSP-929 Description: User should be able to access CSSPortal Epic: Portal Admin
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName | Password |
      | UAP        | UserNameInput | PasswordInput | Bob      | Aussie   |
      | UAP        | UserNameInput | PasswordInput | Leonardo | Aussie   |
