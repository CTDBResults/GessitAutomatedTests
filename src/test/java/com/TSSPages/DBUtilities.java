...
//	 		List<WebElement> list = driver.findElements(By.xpath("//*[contains(text(),'" + arg1 + "')]"));
//	 
...
//				
				...
				public WebElement getLinkFromListInTableRecord(String arg1, String arg2, DataTable table) throws InterruptedException
				{
					int index = getTableRowIndexByElement(table);
