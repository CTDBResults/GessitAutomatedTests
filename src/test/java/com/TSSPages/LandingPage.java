...
public class LandingPage extends DBUtilities {
	...
	/*
	 * following need to be used carefully as we are calling xpaths based on
	 * ......HS(i know its getting complex) how they are designed in code they
	 * could be by id, by name, or by span id.
	 */
	public void checkElementPresentOnScreen(DataTable table) throws InterruptedException {
		...
		for (int i = 1; i < data.size(); i++) {
			...
			if (name.equals("Current_Bill") || name.equals("Pay") || name.equals("Submit") || name.equals("Cancel")
					|| name.equals("Date") || name.equals("Activity") || name.equals("Description")
					|| name.equals("Counter") || name.equals("Type") || name.equals("SaveAndExit")
					|| name.equals("Next") || name.equals("Save") || name.equals("Amount")
