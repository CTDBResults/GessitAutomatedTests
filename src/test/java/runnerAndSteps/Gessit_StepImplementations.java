...
//	    driver.manage().window().maximize();
	...
	public String i_capture(String arg1) throws Throwable {
			...
			if(arg1.equals("html")){
				Gessit_StepImplementations.Capture = driver.getPageSource();
	...
	public void i_paste(String arg1) throws Throwable {
	      System.out.println(Gessit_StepImplementations.Capture);
		...
		driver.findElement(By.xpath("//*[contains(@id, 'checkpaste')]")).sendKeys(Gessit_StepImplementations.Capture);
...
//	     t1.isTextPresent(elementToBeSearched);
  ...
  PageFactory.initElements(driver, LandingPage.class).hitTab();
	...
	public void i_click_on_button(String arg1) throws Throwable {
		...
		((JavascriptExecutor)
				driver).executeScript("arguments[0].scrollIntoView(true);", exist);
		exist.click();
...
//		Assert.assertTrue(currentValue.equals(arg2));
	...
	public void i_click_on_radio_option(String arg1) throws Throwable {
		...
		//String myxpath = PageFactory.initElements(driver, Gessit_AddPatientPage.class).xpathMakerById(arg1);
...
//	public void i_see_the_number_of_table_records_displayed(String arg1) throws Throwable {
...
//		PageFactory.initElements(driver, DBUtilities.class).checkTableRecordsOrder(arg1, arg2);
//	}
...
//		myEdit.click();			
//	} 
//	TO DO for Justin toget the button name done.....later remove this step and use the generic step...
...
public void i_should_see_displayed_in_table(String arg1, String arg2, String arg3) throws Throwable {
  ...
  Assert.assertTrue(driver.findElement(By.xpath(checkElementInTable)).isDisplayed());
	...
	public void i_see_is_in_field_and_is_displayed_as(String arg1, String arg2, String arg3, String arg4, DataTable table) throws Throwable {
...
//	}
	...
	public void i_click_on_of_the_list_from_the_record_with(String arg1, String arg2, DataTable table) throws Throwable {
		Thread.sleep(3000);
		DBUtilities dbutilities = new DBUtilities(driver);
	...
	// Checking the value of element attributes, for example, checking the value of class, or type or value attributes
       ...
       if (arg1.equals("NVX")){
		...
		System.out.println(" Selecting radio option " +arg1);
   		...
   		if (arg2.equals("XPN")){
 			...
 			String myxpath2 = PageFactory.initElements(driver, Gessit_AddPatientPage.class).xpathMakerByIdAndlabel(arg2);
 			driver.findElement(By.xpath(myxpath2)).click();
 		...
 		// this is for Outcome
 				...
 				if(arg3.equals("XNX")){
 					...
 					String myxpath3 = PageFactory.initElements(driver, Gessit_AddPatientPage.class).xpathMakerByIdAndlabel(arg3);
